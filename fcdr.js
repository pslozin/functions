...
let names = ["Philip","Joe","Bill","Donald"]
...
const theEliminator = (names,status) => {
...
Each chocolate frog costs 3 gold. Your function should take in a single parameter, which is the amount 
...
console.log(verifyArray(sampleArray))
